...
{
    public class NoteListFragment : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            var v = inflater.Inflate(
                Resource.Layout.FragmentNodeList, container, false);
        ...
        void setupRecyclerView(RecyclerView recyclerView)
        {
            ...
            recyclerView.SetAdapter(new SimpleStringRecyclerViewAdapter(Activity,
                getRandomSublist(Notes.NoteList, 30)));
        }
        ...
        public class SimpleStringRecyclerViewAdapter : RecyclerView.Adapter
        {
            ...
            public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
            {
                ...
                var view = LayoutInflater.From(parent.Context)
                    .Inflate(Resource.Layout.NoteListItem, parent, false);
            ...
            public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                h.ClickHandler = new EventHandler((sender, e) => {
                    ...
                    var intent = new Intent(context, typeof(NoteDetailActivity));
                    intent.PutExtra(NoteDetailActivity.EXTRA_NAME, h.BoundString);

                    context.StartActivity(intent);
                });
                h.View.Click += h.ClickHandler;

                h.ImageView.SetImageDrawable(Notes.GetRandomCheeseDrawable(parent));
            }
